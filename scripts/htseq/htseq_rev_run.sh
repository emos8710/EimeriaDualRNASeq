...
do
    ...
    htseq-count -f bam -r pos -s reverse -i ID -n 10 ${f}_Aligned.sortedByCoord.out.bam reference_genomes/GCF_016699485.2_bGalGal1.mat.broiler.GRCg7b_IBV_Ind-TN92-03.gtf \
