...
do
    ...
    software/STAR/source/STAR --genomeDir /proj/naiss2025-23-525/results/star/index --readFilesIn ${f}_R1_paired.fastq.gz ${f}_R2_paired.fastq.gz --readFilesCommand gunzip -c \
    ...
    software/STAR/source/STAR --genomeDir /proj/naiss2025-23-525/results/star/index --readFilesIn ${f}_R1_unpaired.fastq.gz --readFilesCommand gunzip -c \
    ...
    software/STAR/source/STAR --genomeDir /proj/naiss2025-23-525/results/star/index --readFilesIn ${f}_R2_unpaired.fastq.gz --readFilesCommand gunzip -c \
